...
export const FloatingWhatsApp = () => (
  ...
  >
    ...
    <span className="max-w-0 overflow-hidden whitespace-nowrap text-xs font-bold tracking-wide transition-[max-width,padding] duration-500 group-hover:max-w-[160px] group-hover:pr-5">
      Chat with us
    </span>
  </motion.a>
);
